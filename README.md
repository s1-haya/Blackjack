...
### 2.ゲーム性(追加機能)
ブラックジャックの遊び方と追加機能の詳細に関しては(https://github.com/s1-haya/Blackjack/blob/main/README.md#%E9%81%8A%E3%81%B3%E6%96%B9)<br>
...
具体的にはゲーム性は遊び方の特別ルール()に記載しています。<br>
...
そこで山札の設置、Round毎回にチップを減らす。また戦略法を取り入れることによって勝敗に対してより戦略的になり、<br>
